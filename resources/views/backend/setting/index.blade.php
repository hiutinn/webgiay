                    ...
                    <form role="form" action="{{ route('admin.setting.update', ['id' => $setting->id ]) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="introduce" name="introduce" class="form-control" rows="10" >{{ $setting->introduce }}</textarea>
                            </div>

                            <div class="form-group">
                                <label>Chính sách bảo mật</label>
                                <textarea id="privacy_policy" name="privacy_policy" class="form-control" rows="10" >{{ $setting->privacy_policy }}</textarea>
                            </div>
                        </div>
                        <!-- /.box-body -->

        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li>
                <a href="{{route('admin.category.index')}}">
                    <i class="fa fa-fw fa-bars"></i> <span>QL Danh Mục</span>
            ...
            <li>
                <a href="{{route('admin.article.index')}}">
                    <i class="fa fa-fw  fa-file-text-o"></i> <span>QL Bài Viết</span>
                    <span class="pull-right-container"></span>
                </a>
            </li>
{{--            <li>--}}
...
{{--                    <i class="fa fa-fw fa-truck"></i> <span>QL Nhà Cung Cấp</span>--}}
{{--                    <span class="pull-right-container"></span>--}}
{{--                </a>--}}
{{--            </li>--}}
            <li>

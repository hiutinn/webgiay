<header class="main-header">
    ...
    <a href="/" class="logo" style="background-color: #FFFFFF">
        ...
        <span class="logo-mini"><img src="/image/something.png" alt=""></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><img src="/image/something.png" alt=""></span>
    </a>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <span class="hidden-xs">{{ Auth::user()->name}} - Web Developer</span>
                    </a>
